...
export const projects = [
  ...
  },
  {
    ...
    title: "App Móvil Salud",
    stack: "React Native · Firebase",
    likes: 187,
    comments: 9,
    desc: "Aplicación multiplataforma para seguimiento de hábitos saludables, meditación y rutinas de ejercicio. Incluye notificaciones push, sincronización en la nube y modo offline.",
  ...
  },
  {
    ...
    likes: 401,
    comments: 35,
    desc: "Sistema de diseño completo con más de 80 componentes reutilizables, documentados en Storybook. Implementa accesibilidad WCAG 2.1 y soporte para modo oscuro/claro.",
    tags: ["Figma", "Storybook", "CSS Modules", "Jest", "TypeScript"],
    githubUrl : "https://github.com/japmming",
  },
  {
    lucideIcon: "Home",
